<!doctype html>
<!-- EE 341L Communication Systems Laboratory: EE341L.html -->
      ...
      <div id="content">
          <div class="grid_12">
			  ...
			  <h3>
                ...
                <p>
    			Wed 1:30-2:30 in Holmes 386, or by appointment.
                </p>
			  <h3>
			Lab Schedule
			  </h3>
			...
			<p>
			Final course grades will be weighted according to one of the following Schemas.  The Schema that produces the higher grade will be used on a student-by-student basis.
			<h4>
			Schema A
			</h4>
			<p>
